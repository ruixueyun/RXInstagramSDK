...
Pod::Spec.new do |s|
  s.name             = 'RXInstagramSDK'
  s.version          = '1.0.2'
#  s.version          = '1.0.0.100'
  s.summary          = 'ruixue RXInstagramSDK framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXInstagramSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXInstagramSDK.git', :tag => s.version.to_s }
